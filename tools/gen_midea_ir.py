...
def build_test_file():
    ...
    # --- TEMPORAL: sonda de iconos de apagado. Todos emiten el OFF del
    # grupo A. Cuando se elija uno, borrar este bloque entero.
    for etiqueta in (u"1 ❌", u"2 ⛔", u"3 🔌",
                     u"4 ⭕", u"5 ✖", u"6 ○",
                     u"7 ×"):
        out.append(block(etiqueta, bosch_raw(BOSCH_OFF)))
